# Generated by Django 4.1.5 on 2023-03-17 10:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('M', 'Mobile'), ('L', 'Laptop'), ('TW', 'Top Wear'), ('BW', 'Bottom Wear'), ('W', 'Watch'), ('BT', 'Bueaty item'), ('ELE', 'Electronic item'), ('B', 'Bags')], max_length=200)),
